...
export const metadata: Metadata = {
  ...
  description: 'Add ABDM, TeleICU, AI Scribe, and more with Care Apps—plugins that extend CARE without changing the core.',
  keywords: 'healthcare integrations, ABDM plugin, ONVIF TeleICU, AI scribe, FHIR plugins',
}
      ...
      <Container className="relative">
        ...
        <div className="pt-16 pb-24 sm:pt-24 sm:pb-32 md:pt-32 md:pb-48">
          ...
          <p className="mt-8 max-w-4xl text-xl/7 font-medium text-gray-950/75 sm:text-2xl/8">
            Browse verified apps and integrations for national rails, telemetry, documentation, labs, pharmacy, billing, analytics.
          </p>
          <div className="mt-12 flex flex-col gap-x-6 gap-y-4 sm:flex-row">
            <Button href="/contact">Browse all integrations</Button>
            <Button variant="secondary" href="/developers">Request an integration</Button>
            <Button variant="secondary" href="/developers">Submit your plugin</Button>
          </div>
        </div>
      </Container>
    </div>
          ...
          graphic={
            <div className="h-80 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-700 mt-2">6 States Deployed</div>
              </div>
            </div>
          }
          fade={['bottom']}
          ...
          graphic={
            <div className="h-80 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-sm text-green-700 mt-2">Real-time Monitoring</div>
              </div>
            </div>
          }
          fade={['bottom']}
          ...
          graphic={
            <div className="h-80 bg-gradient-to-br from-purple-50 to-purple-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-sm text-purple-700 mt-2">Voice Fill</div>
              </div>
            </div>
          }
          fade={['bottom']}
...
function CategoriesSection() {
  const categories = [
    { name: 'National & ID', description: 'ABDM, Aadhaar, National ID systems' },
    { name: 'Telemetry & Video', description: 'ONVIF, RTSP, medical device integration' },
    { name: 'Documentation & AI', description: 'Voice-to-text, AI scribe, clinical notes' },
    { name: 'Labs & Diagnostics', description: 'Lab equipment, diagnostic tools, results' },
    { name: 'Pharmacy & Supply', description: 'Inventory, procurement, supply chain' },
    ...
    { name: 'Data & Dashboards', description: 'Analytics, reporting, business intelligence' },
  ]
