...
export const metadata: Metadata = {
  ...
  description: 'A global community co‑building open, FHIR‑aligned health infrastructure with Care Core and Care Apps.',
  keywords: 'open health ecosystem, digital public goods community, healthcare plugins, FHIR contributors',
}
...
const timelineItems = [
  ...
  },
  {
    ...
    purpose: "CARE identified as the teleICU tooling for 10BedICU Project, enabling technology-driven ICU care in rural India and providing TeleICU services to the remotest regions, impacting thousands of lives.CARE is deployed as part of the project by State health departments across government hospitals.",
    features: [
      ...
      <Container className="relative">
        ...
        <div className="pt-16 pb-24 sm:pt-24 sm:pb-32 md:pt-32 md:pb-48">
          ...
          <p className="mt-8 max-w-4xl text-xl/7 font-medium text-gray-950/75 sm:text-2xl/8">
            Governments, hospitals, implementers, researchers, and volunteers co‑build around <strong>Care Core</strong> and <strong>Care Apps</strong>.
          </p>
          <div className="mt-12 flex flex-col gap-x-6 gap-y-4 sm:flex-row">
            <Button href="/developers">Join the developer community</Button>
            <Button variant="secondary" href="/contact">Partner as an implementer</Button>
            <Button variant="secondary" href="/contact">Sponsor a state program</Button>
          </div>
        </div>
      </Container>
    </div>
    ...
    <Container className="py-24">
      ...
      <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 text-center">
          ...
          <p className="text-blue-700 font-medium">Contributors</p>
        </div>
        <div className="bg-green-50 p-6 rounded-lg border border-green-200 text-center">
          <div className="text-4xl font-bold text-green-900 mb-2">14+</div>
          <p className="text-green-700 font-medium">Core maintainers</p>
        </div>
        <div className="bg-purple-50 p-6 rounded-lg border border-purple-200 text-center">
          <div className="text-4xl font-bold text-purple-900 mb-2">50%</div>
          <p className="text-purple-700 font-medium">Growth in last 6 months</p>
        </div>
      </div>
    </Container>
  )
            ...
            graphic={
              <div className="h-80 bg-gradient-to-br from-green-50 to-green-100 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-sm text-green-700 mt-2">Solutions</div>
                </div>
              </div>
            }
            fade={['bottom']}
    ...
    <Container className="py-24">
      ...
      <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-4">
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="text-blue-700">National and state health departments deploying CARE at scale</p>
        </div>
        <div className="bg-green-50 p-6 rounded-lg border border-green-200">
          <h3 className="text-lg font-semibold text-green-900 mb-2">Hospitals</h3>
          <p className="text-green-700">Healthcare facilities using CARE for patient care and management</p>
        </div>
        <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
          <h3 className="text-lg font-semibold text-purple-900 mb-2">Implementers</h3>
          <p className="text-purple-700">Technology partners and system integrators deploying CARE</p>
        </div>
        <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
          <h3 className="text-lg font-semibold text-orange-900 mb-2">Researchers</h3>
          <p className="text-orange-700">Academic and research institutions contributing to CARE development</p>
        </div>
      </div>
    </Container>
  )
