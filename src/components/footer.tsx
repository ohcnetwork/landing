...
function Copyright() {
  return (
    <div className="text-sm/6 text-gray-950">
      &copy; {new Date().getFullYear()} Open Healthcare Network. OHC stewards healthcare <strong>Digital Public Goods</strong>. <strong>MIT License.</strong> Data ownership remains with deploying governments and institutions.
    </div>
  )
}
