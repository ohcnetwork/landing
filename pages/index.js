  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        <div className="text-black flex items-center justify-center py-20 bg-gray-50 my-20">
          <div className="p-4 md:p-0 md:w-3/4">
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <img
                src="/github-org-page.png"
                alt="Open Healthcare Network Github"
              ...
              <div className="">
                ...
                <p className="text-gray-500 mt-6 text-sm">
                  From the very beginning, Open Healthcare Network has embraced
                  open-source principles, believing in the power of community
                  and collaboration. Our mission is to foster a community of
                  developers dedicated to leveraging technology to address
                  healthcare challenges. By remaining open source, we ensure
                  that innovation is driven by collective effort and shared
                  knowledge. Join us in our journey to revolutionize healthcare
                  through the power of open-source technology and
                  community-driven solutions.
                </p>
                <Link
                  href={"https://github.com/coronasafe"}
                  className="bg-primary-500 hover:bg-primary-600 text-white rounded-[100px] hover:rounded-2xl transition-all font-bold py-3 px-4 pr-4 inline-flex mt-6 items-center gap-2"
                >
                  <svg
                    fill="currentColor"
                    viewBox="0 0 24 24"
